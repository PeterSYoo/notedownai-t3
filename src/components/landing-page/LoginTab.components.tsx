      ...
      <section className="flex flex-col gap-5 px-12 pt-10">
        <form className="flex flex-col gap-2">
          ...
          <fieldset className="flex flex-col gap-1">
            ...
            <div className="flex h-[35px] items-center justify-between rounded-lg border border-white/20 pl-2">
              <input
                className="w-full bg-transparent text-white/50 focus:outline-none"
                id="username"
