...
export const InstructionsModal = ({
  setIsInstructionsModal,
}: {
  setIsInstructionsModal: (arg0: boolean) => void;
}) => {
  // ------------------------------------- States ------------------------------------ ***
      ...
      <section className="fixed left-0 top-0 z-50 flex h-screen w-full items-center justify-center">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center gap-2 pb-7 pt-1 text-[#EEE6E1]">
            <h1 className="font-bold">Welcome to NoteDown AI!</h1>
            <p className="max-w-[300px] px-2 text-center text-sm"></p>
          </div>
        </div>
        {/* -------------------------------------------------------------------------- */}
      </section>
